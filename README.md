...
## Environments
- Preview: https://main--swetabar-250814--aemysites.aem.page/
- Live: https://main--swetabar-250814--aemysites.aem.live/
...
1. Open the `swetabar-250814` directory in your favorite IDE and start coding :)
